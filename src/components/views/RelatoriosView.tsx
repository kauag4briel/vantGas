    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 bg-white p-4 rounded-sm border border-slate-200 shadow-2xs">
        <div>
          ...
          <p className="text-xs text-slate-500">
            Geração de demonstrativos contábeis, operacionais e fiscais em conformidade com TCE/TCM
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={handlePrint}
            className="flex items-center gap-1.5 px-3 py-2 rounded-sm border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 text-xs font-semibold cursor-pointer"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 rounded-sm bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold shadow-2xs cursor-pointer"
          >
      ...
      <div className="flex flex-wrap gap-2 border-b border-slate-200 pb-2">
        <button
          ...
          className={`flex items-center gap-2 px-3.5 py-2 rounded-sm text-xs font-semibold cursor-pointer transition-all ${
